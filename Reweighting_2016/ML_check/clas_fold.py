...
for n in range(0,10):
    if n == primFoldnumber:
        continue
    foldnameList.append('/home/oliver/Master_Thesis/storage/Reweighting_2016_ML_check/folds/fold'+ str(n) +'.root')
...
train_features = [ "nTracks", "B0_PT", "B0_ENDVERTEX_CHI2", "B0_DIRA_OWNPV", "B0_IP_OWNPV", "B0_FD_OWNPV", "B0_FDCHI2_OWNPV", "B0_IPCHI2_OWNPV" ]
uniform_features = []
n_estimators = 500
...
for clasN in clasNameList:
    ...
    bdtHist.savefig('/home/oliver/Master_Thesis/storage/Reweighting_2016_ML_check/'+clasN+'Hist_fold'+ str(primFoldnumber) +'.png')
    del bdtHist
    n_fig+=1

testX.to_root('/home/oliver/Master_Thesis/storage/Reweighting_2016_ML_check/folds/clas_fold'+ str(primFoldnumber) +'.root')
...
multiGr.Draw()
leg.Draw()
c1.SaveAs('/home/oliver/Master_Thesis/storage/Reweighting_2016_ML_check/fold'+ str(primFoldnumber) +'_roc.pdf')
